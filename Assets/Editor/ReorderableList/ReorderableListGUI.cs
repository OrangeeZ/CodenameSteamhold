...
namespace Rotorz.ReorderableList
{
    ...
    public static class ReorderableListGUI
    {
        ...
        public static void ListField<T>(IList<T> list, ReorderableListControl.ItemDrawer<T> drawItem, ReorderableListControl.DrawEmpty drawEmpty, Func<int, float> heightFunction, float minHeight)
        {
            var adaptor = new ActionListAdaptor<T>(list, drawItem, heightFunction, minHeight);
            ReorderableListControl.DrawControlFromState(adaptor, drawEmpty, 0);
        }
